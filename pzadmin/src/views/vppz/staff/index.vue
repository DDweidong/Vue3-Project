<template>
        ...
        <el-table-column label="创建时间">
            <template #default="scope">
                <div class="flex-bow">
                    ...
                    <span style="margin-left: 6px;">{{ scope.row.create_time }}</span>
                </div>
            </template>
        </el-table-column>
    ...
    >
        ...
        >
            ...
            <el-form-item label="头像" prop="avatar">
                <el-button v-if="!form.avatar" type="primary" @click="dialogImageShow=true">点击上传</el-button>
                <el-image 
                    v-else
                    :src="form.avatar"
    ...
    >
        <div class="image-list">
            <div v-for="(item,index) in fileList" :key="item.name" class="img-box" @click="selectImage=index">
                <div v-if="selectImage===index" class="select"> 
        ...
        <template #footer>
                <div class="dialog-footer">
                    <el-button  @click="dialogImageShow=false">取消</el-button>
                    <el-button type="primary" @click="comfirmImage">确认</el-button>
                </div>
        </template>
    </el-dialog>
</template>
...
const comfirmImage=()=>{
    form.avatar=fileList.value[selectImage.value].url
    dialogImageShow.value=false
}
